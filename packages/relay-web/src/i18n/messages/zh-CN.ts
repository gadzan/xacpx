...
export default {
  ...
  desktop: {
    title: "桌面",
    unavailable: "桌面需要在线实例且具备桌面能力。",
    disabled: "桌面未启用。请在实例 config 中开启 `desktop.enabled`。",
    offline: "实例已离线。",
    busy: "该实例已有桌面观看者。",
    ...
    statusAuth: "需要 VNC 密码。",
    statusConnecting: "正在连接桌面…",
    statusOpen: "已连接。",
    statusClosed: "已断开。",
    statusError: "桌面出错。",
    errorTitle: "无法打开桌面。",
  ...
  bot: {
    ...
    validation: {
      ...
      detailLoadFailed: "Bot 详情加载失败（{msg}），请重试后再保存。",
    },
    lifecycle: {
