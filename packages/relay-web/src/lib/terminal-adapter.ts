...
import { patchXtermIosImeInsertText } from "./xterm-ios-ime";
...
async function defaultFactory(
  ...
  // prior keydown). Local #5614 backport; do not restyle the helper textarea.
  patchXtermIosImeInsertText(term);
  return {
