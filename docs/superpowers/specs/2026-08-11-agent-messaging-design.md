...
Implementation status (2026-08-18): Local queue-first v0.1 is implemented in
the current xacpx worktree: stable node/endpoint identities, same-coordinator
...
spike and its required GO report. Relay/Peer routes remain future milestones.
