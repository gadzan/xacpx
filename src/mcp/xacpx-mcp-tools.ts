      ...
      inputSchema: z
        .object({
          ...
          mode: z
            ...
            .optional()
            .describe(
              "Delivery mode (default: auto -> queue). 'interrupt' REQUESTS cancellation of the target's current turn and reserves this message as its highest-priority next turn; xacpx waits for the current turn to fully settle first, and some runtimes may finish it instead of stopping immediately. 'auto' and 'queue' never cancel. 'steer' injects into the target's active turn when the runtime supports it.",
            ),
          replyTo: z
            .string()
            .min(1)
