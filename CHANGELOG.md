...
- Managed adapter pins refreshed (ACP initialize probe passes on both): Codex `1.1.9` → `1.10.0`, Claude `0.64.2` → `0.75.1`. Recorded generated adapter commands refresh to the new defaults automatically; custom recorded commands stay sticky.
