...
test("renders an escaped peer message envelope with reply and conversation metadata", () => {
  expect(
    ...
    '<xacpx-message id="msg_1" conversation-id="conv_root_1" from="agent:node_a:endpoint_a" replyable="true" reply-to="msg_0">\n' +
